...
Node.js 를 위한 빠르고 최소한의 규칙과 기능을 가진 **웹 프레임워크**

1. **간단하고 유연한 서버 개발**
    - **최소한의 구조**로 빠르게 서버를 개발할 수 있다.
    - **최소한의 규칙**과 높은 자유도를 가지고 개발할 수 있다.
2. **미들웨어 기반**
    - **요청**과 **응답** 처리과정을 단계별로 나누어 관리할 수 있다.
    - 로깅, 인증, 에러 처리, 정적 파일 제공 등의 **기능 확장**이 쉽다.
3. **오픈 소스 생태계**
    - **npm** 을 통해 다양한 라이브러리를 쉽게 설치, 연동할 수 있다.
    - **빠르고 유연한** 웹 어플리케이션 개발이 가능하다.
## Express 뼈대 코드
